...
export class CustomValidation {
  ...
  public static isPublicEmail(control: AbstractControl): ValidationErrors {
    const email = control.value;
    const pattern = new RegExp(/^([\w-\.]+@(?!gmail.com)(?!yahoo.com)(?!hotmail.com)(?!yahoo.co.in)(?!aol.com)(?!abc.com)(?!xyz.com)(?!pqr.com)(?!rediffmail.com)(?!live.com)(?!outlook.com)(?!me.com)(?!msn.com)(?!ymail.com)([\w-]+\.)+[\w-]{2,4})?$/);
    if (!pattern.test(email)) {
      return {isPublicEmail: true};
    } else {
      return null;
    }
  }
